...
$title = "Nilai Ujian - SMA Asshiddiqiyah";
            ...
            <div class="row">
                <div class="col-7">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="../ujian/ujian.php">Ujian</li></a>
                ...
                <div class="col-5">
                    <div class="card mt-3 border-0">
                        ...
                        <ul class="ps-3">
                            <li><small>Nilai minimal tiap pelajaran tidak boleh dibawah 50</small></li>
                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="reset" name="reset" class="btn btn-sm btn-danger me-1 float-end"><i
