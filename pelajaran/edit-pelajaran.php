...
$title = "Mata Pelajaran - SMA Asshiddiqiyah";
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="pelajaran.php">Back</li></a>
            </ol>
            <div class="row">
                <div class="col-4">
                    <div class="card">
                                    ...
                                    <select name="guru" id="guru" class="form-select" required>
                                        ...
                                        while ($dataGuru = mysqli_fetch_array($queryGuru)) {
                                            if ($data['guru'] == $dataGuru['nama']) {
                                                ?>
                                                <option value="<?= $dataGuru['nama'] ?>" selected><?= $dataGuru['nama'] ?>
                                                </option>
                                            <?php } else { ?>
