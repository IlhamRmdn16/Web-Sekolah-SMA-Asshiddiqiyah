                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($querySiswa)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><a href="edit-siswa.php?nis=<?= $data['nis'] ?>"
                                            ...
                                            <a href="hapus-siswa.php?nis=<?= $data['nis'] ?>&foto=<?= $data['foto'] ?>"
                                                ...
                                                onclick="return confirm('Anda yakin akan mengapus data ini ?')"><i
