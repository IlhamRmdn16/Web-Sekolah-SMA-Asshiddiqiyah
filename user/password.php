...
$title = "Ganti Password - SMA Asshiddiqiyah";
...
if ($msg == 'updated') {
    ...
    <i class="fa-solid fa-circle"></i> Ganti Password berhasil..
                        ...
                        <div class="mb-3 row">
                            <div class="col-7">
                                ...
                                <input type="password" class="form-control" id="newPass" name="newPass" minlength="4"
                                    maxlength="20" placeholder="Masukan password baru anda" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-7">
