...
$title = "Tambah User - SMA Asshiddiqiyah";
...
if ($msg == 'added') {
  ...
  <i class="fa-solid fa-circle"></i> Tambah user berhasil, segera ganti password anda !
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
            ...
            <div class="row">
              <div class="col-8">
                ...
                <div class="mb-3 row">
                  ...
                  <label for="" class="col-sm-1 col-form-label">:</label>
                  <div class="col-sm-9" style="margin-left: -50px;">
                    <input type="text" class="form-control border-0 border-bottom" id="nama" name="nama" maxlength="20"
                      required>
                  </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <label for="" class="col-sm-1 col-form-label">:</label>
                  <div class="col-sm-9" style="margin-left: -50px;">
                    <textarea name="alamat" id="alamat" cols="30" rows="3" class="form-control" placeholder="domisili"
                      required></textarea>
                  </div>
                </div>
              ...
              <div class="col-4 text-center px-5">
                <img src="../asset/image/default.jpg" alt="gambar user" class="mb-3" width="40%">
