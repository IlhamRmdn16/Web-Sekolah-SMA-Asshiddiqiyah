...
$title = "Tambah Guru - SMA Asshiddiqiyah";
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href="guru.php">Guru</li></a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4 text-center px-5">
                                <img src="../asset/image/default.jpg" class="mb-3" width="40%" alt="">
                                <input type="file" name="image" class="form-control form-control-sm">
                                <small class="text-secondary">Pilih foto PNG, JPG atau JPEG dengan ukuran 1 MB </small>
